...
//
// aliases: русские написания названия для поиска, строчными. Совпадение по подстроке.
//
...
export const SERVICES = [
  ...
  },
  {
    ...
    access:'open',
    pay:'mid',
    desc:'Российский аккаунт покупать не может, витрина для него скрыта. Нужен аккаунт другого региона: с ним можно играть и скачивать с российского IP, а пополнять - подарочными картами того же региона или через посредника.',
